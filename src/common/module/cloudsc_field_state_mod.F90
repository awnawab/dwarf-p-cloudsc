...
CONTAINS
  ...
  FUNCTION COPY_BULK_STORAGE_TO_DEVICE(ARR) RESULT(DEVPTR)
  ...
  SUBROUTINE COPY_BULK_STORAGE_TO_HOST(ARR, PTR)
    REAL(KIND=JPRB), POINTER, CONTIGUOUS, INTENT(INOUT) :: ARR(:,:,:,:)
    REAL(KIND=JPRB), POINTER, CONTIGUOUS, INTENT(INOUT) :: PTR(:,:,:,:)
    INTEGER(KIND=JPIM) :: ARRSIZE
    TYPE(C_DEVPTR) :: DPTR
    ...
    DPTR = ACC_DEVPTR(PTR)
    CALL ACC_MEMCPY_FROM_DEVICE(ARR, DPTR, ARRSIZE)
