...
CONTAINS
  ...
  FUNCTION COPY_BULK_STORAGE_TO_DEVICE(ARR, DEVDATA) RESULT(DEVPTR)
    REAL(KIND=JPRB), POINTER, CONTIGUOUS, INTENT(IN) :: ARR(:,:,:,:)
  ...
  END FUNCTION COPY_BULK_STORAGE_TO_DEVICE

  SUBROUTINE COPY_BULK_STORAGE_TO_HOST(ARR, DEVDATA)
    REAL(KIND=JPRB), POINTER, CONTIGUOUS, INTENT(INOUT) :: ARR(:,:,:,:)
    REAL(KIND=JPRB), DEVICE, ALLOCATABLE, INTENT(INOUT) :: DEVDATA(:,:,:,:)
    INTEGER(KIND=JPIM) :: ARRSIZE
