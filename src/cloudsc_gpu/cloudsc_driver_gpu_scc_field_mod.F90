...
!...Move bulk allocations to device
    DEVPTR_RDONLY => COPY_BULK_STORAGE_TO_DEVICE(FIELD_STATE%DATA_RDONLY)
    DEVPTR_RWONLY => COPY_BULK_STORAGE_TO_DEVICE(FIELD_STATE%DATA_RWONLY)

!...Retrieve device pointers for bulk allocated fields
    CALL FIELD_STATE%F_PT%GET_DEVPTR(PT, FIELD_STATE%DATA_RDONLY, 1)
    CALL FIELD_STATE%F_PQ%GET_DEVPTR(PQ, FIELD_STATE%DATA_RDONLY, 2)
    CALL FIELD_STATE%F_PVFA%GET_DEVPTR(PVFA, FIELD_STATE%DATA_RDONLY, 3)
    CALL FIELD_STATE%F_PVFL%GET_DEVPTR(PVFL, FIELD_STATE%DATA_RDONLY, 4)
    CALL FIELD_STATE%F_PVFI%GET_DEVPTR(PVFI, FIELD_STATE%DATA_RDONLY, 5)
    CALL FIELD_STATE%F_PDYNA%GET_DEVPTR(PDYNA, FIELD_STATE%DATA_RDONLY, 6)
    CALL FIELD_STATE%F_PDYNL%GET_DEVPTR(PDYNL, FIELD_STATE%DATA_RDONLY, 7)
    CALL FIELD_STATE%F_PDYNI%GET_DEVPTR(PDYNI, FIELD_STATE%DATA_RDONLY, 8)
    CALL FIELD_STATE%F_PHRSW%GET_DEVPTR(PHRSW, FIELD_STATE%DATA_RDONLY, 9)
    CALL FIELD_STATE%F_PHRLW%GET_DEVPTR(PHRLW, FIELD_STATE%DATA_RDONLY,10)
    CALL FIELD_STATE%F_PVERVEL%GET_DEVPTR(PVERVEL, FIELD_STATE%DATA_RDONLY,11)
    CALL FIELD_STATE%F_PAP%GET_DEVPTR(PAP, FIELD_STATE%DATA_RDONLY,12)
    CALL FIELD_STATE%F_PLU%GET_DEVPTR(PLU, FIELD_STATE%DATA_RDONLY,13)
    CALL FIELD_STATE%F_PLUDE%GET_DEVPTR(PLUDE, FIELD_STATE%DATA_RDONLY,14)
    CALL FIELD_STATE%F_PSNDE%GET_DEVPTR(PSNDE, FIELD_STATE%DATA_RDONLY,15)
    CALL FIELD_STATE%F_PMFU%GET_DEVPTR(PMFU, FIELD_STATE%DATA_RDONLY,16)
    CALL FIELD_STATE%F_PMFD%GET_DEVPTR(PMFD, FIELD_STATE%DATA_RDONLY,17)
    CALL FIELD_STATE%F_PA%GET_DEVPTR(PA, FIELD_STATE%DATA_RDONLY,18)
    CALL FIELD_STATE%F_PSUPSAT%GET_DEVPTR(PSUPSAT, FIELD_STATE%DATA_RDONLY,19)
    CALL FIELD_STATE%F_PLCRIT_AER%GET_DEVPTR(PLCRIT_AER, FIELD_STATE%DATA_RDONLY,20)
    CALL FIELD_STATE%F_PICRIT_AER%GET_DEVPTR(PICRIT_AER, FIELD_STATE%DATA_RDONLY,21)
    CALL FIELD_STATE%F_PRE_ICE%GET_DEVPTR(PRE_ICE, FIELD_STATE%DATA_RDONLY,22)
    CALL FIELD_STATE%F_PCCN%GET_DEVPTR(PCCN, FIELD_STATE%DATA_RDONLY,23)
    CALL FIELD_STATE%F_PNICE%GET_DEVPTR(PNICE, FIELD_STATE%DATA_RDONLY,24)

    CALL FIELD_STATE%F_PFSQLF%GET_DEVPTR(PFSQLF, FIELD_STATE%DATA_RWONLY, 1)
    CALL FIELD_STATE%F_PFSQIF%GET_DEVPTR(PFSQIF, FIELD_STATE%DATA_RWONLY, 2)
    CALL FIELD_STATE%F_PFCQLNG%GET_DEVPTR(PFCQLNG, FIELD_STATE%DATA_RWONLY, 3)
    CALL FIELD_STATE%F_PFCQNNG%GET_DEVPTR(PFCQNNG, FIELD_STATE%DATA_RWONLY, 4)
    CALL FIELD_STATE%F_PFSQRF%GET_DEVPTR(PFSQRF, FIELD_STATE%DATA_RWONLY, 5)
    CALL FIELD_STATE%F_PFSQSF%GET_DEVPTR(PFSQSF, FIELD_STATE%DATA_RWONLY, 6)
    CALL FIELD_STATE%F_PFCQRNG%GET_DEVPTR(PFCQRNG, FIELD_STATE%DATA_RWONLY, 7)
    CALL FIELD_STATE%F_PFCQSNG%GET_DEVPTR(PFCQSNG, FIELD_STATE%DATA_RWONLY, 8)
    CALL FIELD_STATE%F_PFSQLTUR%GET_DEVPTR(PFSQLTUR, FIELD_STATE%DATA_RWONLY, 9)
    CALL FIELD_STATE%F_PFSQITUR%GET_DEVPTR(PFSQITUR, FIELD_STATE%DATA_RWONLY,10)
    CALL FIELD_STATE%F_PFPLSL%GET_DEVPTR(PFPLSL, FIELD_STATE%DATA_RWONLY,11)
    CALL FIELD_STATE%F_PFPLSN%GET_DEVPTR(PFPLSN, FIELD_STATE%DATA_RWONLY,12)
    CALL FIELD_STATE%F_PFHPSL%GET_DEVPTR(PFHPSL, FIELD_STATE%DATA_RWONLY,13)
    CALL FIELD_STATE%F_PFHPSN%GET_DEVPTR(PFHPSN, FIELD_STATE%DATA_RWONLY,14)
...
!...Move bulk allocations to device
    CALL COPY_BULK_STORAGE_TO_HOST(FIELD_STATE%DATA_RWONLY, DEVPTR_RWONLY)
