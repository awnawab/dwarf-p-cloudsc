...
!$acc end data
    ...
    CALL FIELD_STATE%F_PFSQLF%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFSQIF%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFCQLNG%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFCQNNG%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFSQRF%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFSQSF%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFCQRNG%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFCQSNG%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFSQLTUR%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFSQITUR%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFPLSL%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFPLSN%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFHPSL%ENSURE_HOST()! Second block
    CALL FIELD_STATE%F_PFHPSN%ENSURE_HOST()! Second block
